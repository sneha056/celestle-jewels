    ...
    <div class="sticky-active">
      <div class="container1 custom-container">
        <div class="row logo-div">
          <div class="col-xl-1 col-md-auto col-auto logo">
            <a href="index.html">
              ...
              <ul>
                ...
                <li class="menu-item-has-children mega-menu-wrap">
                  ...
                  <ul class="sub-menu">
                    ...
                    <li><a href="Kangan.html">Kangan</a></li>
                    <li><a href="Rings.html">Rings</a></li>
                    <li><a href="bahi.html">Bahi</a></li>
                    <li><a href="Tikka.html">Tikka</a></li>
                  </ul>
                </li>
                <li class="menu-item-has-children">
          ...
          <div class="col-xl-3 col-md-auto col-auto" id="gold-price-btn">
            <button id="gold-price-24k">Loading..</button>
            <button id="gold-price-22k">Loading..</button>
            <button id="gold-price-18k">Loading..</button>
          </div>
          <div class="col-xl-2 col-md-auto col-auto">
            <div class="header-wc wish-cart">
              <a class="" href="wishlist.html">Wishlist
              ...
              <div class="header-wc wish-cart">
              <a class="wc-linkbag" href="bag.html">bag 
...
var myHeaders = new Headers();
    ...
    fetch("https://www.goldapi.io/api/XAU/INR", requestOptions)
      ...
      .then(result => {
        const price24k = (result.price_gram_24k*10+5000).toFixed(0);
        const price22k = (result.price_gram_22k*10+5000).toFixed(0);
        const price18k = (result.price_gram_18k*10+5000).toFixed(0);
        document.getElementById('gold-price-24k').innerHTML = `24k ${price24k}`;
        document.getElementById('gold-price-22k').innerHTML = `22k ${price22k}`;
        document.getElementById('gold-price-18k').innerHTML = `18k ${price18k}`;
      })
